...
class MediaFilesControllerTest < ActionController::TestCase
  ...
  test "should create media_file" do
    assert_difference('MediaFile.count') do
      post :create, media_file: { cache: @media_file.cache, description: @media_file.description, name: @media_file.name, store: @media_file.store }
    end
  ...
  test "should update media_file" do
    patch :update, id: @media_file, media_file: { cache: @media_file.cache, description: @media_file.description, name: @media_file.name, store: @media_file.store }
    assert_redirected_to media_file_path(assigns(:media_file))
  end
